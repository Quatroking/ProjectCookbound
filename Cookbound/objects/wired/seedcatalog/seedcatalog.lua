...
world.logInfo("seedcatalog.lua:init(): ultimate box has done its init")
...
function onInteraction(args)
  ...
  ["paneLayout"] = {
    ...
    ["background"] = {
      ["type"] = "background",
      ["fileHeader"] = "/interface/seedcatalog/craftingheader.png",
      ["fileBody"] = "/interface/seedcatalog/craftingbody.png",
      ["fileFooter"] = "/interface/seedcatalog/craftingfooter.png"
    },
    ["close"] = {
      ["type"] = "button",
    ...
    ["windowtitle"] = {
      ["type"] = "title",
      ["title"] = "  SEED COMPUTER CATALOG",
      ["subtitle"] = "  When you really need seeds",
      ["position"] = {-5, 252},
      ["icon"] = {
        ["type"] = "image",
        ["file"] = "/interface/seedcatalog/craftingtable.png",
        ["position"] = {0, -20},
        ["zlevel"] = -1
      }
    },
    ...
    ["scrollArea"] = {
      ...
      ["children"] = {
        ["itemList"] = {
          ["type"] = "list",
          ["schema"] = {
            ["selectedBG"] = "/interface/seedcatalog/craftableselected.png",
            ["unselectedBG"] = "/interface/seedcatalog/craftablebackground.png",
            ["spacing"] = {0, 1},
            ["memberSize"] = {156, 20},
            ["listTemplate"] = {
              ["background"] = {
                ["type"] = "image",
                ["file"] = "/interface/seedcatalog/craftablebackground.png",
                ["position"] = {0, 0},
                ["zlevel"] = -1
              },
              ["itemName"] = {
...
local b = {
  ...
  for _,bt in ipairs(buttons) do
    ...
    if num > buttonArrayMaxWidth*buttonArrayMaxHeight then 
      fullLabel = {
        ["type"] = "image",
        ["file"] = "/interface/seedcatalog/maxbuttons.png",
    ...
    if not bt["baseImage"] then bt["baseImage"] = "/interface/seedcatalog/iconmissing.png" end
    if not bt["baseImageChecked"] then bt["baseImageChecked"] = "/interface/seedcatalog/iconmissingchecked.png" end
